 ...
 */
#define E0_AUTO_FAN_PIN -1 // AQQ - do sprawdzenia gdzie 
...
// @section bltouch
  ...
  #define BLTOUCH_DELAY 500 // Potusek
...
#define DISABLE_INACTIVE_Z false  // Set 'false' if the nozzle could fall onto your printed part! // Potusek
 ...
 */
   ...
   */
  #define MONITOR_DRIVER_STATUS // Potusek
   ...
   */
  #define HYBRID_THRESHOLD // Potusek
